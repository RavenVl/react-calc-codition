    ...
    return (
        <div className={classes.root}>
            <Grid container spacing={24}>
                ...
                <Grid item xs={12} sm={6}>
                    <Paper className={classes.paper}>
                       <h4>Дополнительные параметры</h4>
                        <Paper className={classes.paper}>
                            <Tooltip id="tooltip-icon" title="При выборе этой опции мощность будет увеличенна, для компенсации вентиляции">
                        ...
                        <Paper className={classes.paper}>
                            ...
                            />
                            <Paper className={classes.paper}>
                                <Tooltip id="tooltip-icon" title="При выборе этой опции мощность будет увеличенна, для компенсации нагретой крыши">
                                    <IconButton aria-label="">
                                        <Announcement />
                                    </IconButton>
                                </Tooltip>
                            ...
                            <Paper className={classes.paper}>
                                <Tooltip id="tooltip-icon" title="При выборе этой опции мощность будет увеличенна, чтобы при любой аномально жаркой погоде гарантировать 20°С в помещении">
                                    <IconButton aria-label="">
                                        <Announcement />
                                    </IconButton>
                                </Tooltip>
                ...
                <Grid item xs={12}>
                    <Paper className={classes.paper}>
                        <Button variant="contained" color="primary" className={classes.button} onClick={this.handleCalc}>
                            Расчитать
                        </Button>
                    </Paper>
                    <Paper className={classes.paper}>
                ...
                <Grid item xs={12}>
                    <Paper className={classes.paper}>Результаты расчета</Paper>
                </Grid>
